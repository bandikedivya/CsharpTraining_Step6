...
using static AnonymousMethodsWithReturn.Program;

namespace AnonymousMethodsWithReturnToLambda
{
    //Anonymous Method will not have  name and is defined using delegate keyword.

    //Anonymous Method To Lambda Expression with return.
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //bool return type
            Checkfood checkfood = (string orderName) =>
            {
            ...
            // void method type
            Takeorderfood takeorderfood = (string custName, string orderName) =>
            {
            ...
            //string return type
            Prepareorderfood prepareorderfood = (string custName, string orderName) =>
            {
            ...
            //int method type
            Quantity foodquantity = (string custName, string Ordername) =>
            {
                int quantity = 2;
                return quantity;
            };
            ...
            CustomerBill custbill = (string custName, string orderName) =>
            {
                double price = 1500;
                return price;
            };
